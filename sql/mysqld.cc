...
SHOW_VAR com_status_vars[]= {
  ...
  {"create_synonym",       STMT_STATUS(SQLCOM_CREATE_SYNONYM)},
  ...
  {"drop_synonym",         STMT_STATUS(SQLCOM_DROP_SYNONYM)},
  ...
  {"show_create_synonym",  STMT_STATUS(SQLCOM_SHOW_CREATE_SYNONYM)},

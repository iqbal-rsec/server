...
public:
  ...
  bool Item_func_in_fix_comparator_compatible_types(THD *thd,
                                                    Item_func_in *) const
    override;
  bool get_item_index(THD *thd, const Item_field *item, const LEX_CSTRING& name, uint& idx) const override;
  Item_field *get_item(THD *thd, const Item_field *item, const LEX_CSTRING& name) const override;
  Field *get_field(THD *thd, Item_field *item, const LEX_CSTRING& name) const override
  {
    return get_field(thd, const_cast<const Item_field *>(item), name);
  }
  Field *get_field(THD *thd, const Item_field *item, const LEX_CSTRING& name) const override;
};
...
public:
  ...
  using Type_handler_composite::create_item_method;
  Item *create_item_method(THD *thd,
                        Item_splocal *array,
                        const Lex_ident_cli_st *method_name,
                        List<Item> *args) const override;

  bool key_to_lex_cstring(THD *thd, Item **key, const LEX_CSTRING& name, LEX_CSTRING& out_key) const override;

...
{
  sp_instr_set_composite_field_by_name(const sp_instr_set_composite_field_by_name &);
...
{
  sp_instr_set_composite_field_by_key(const sp_instr_set_composite_field_by_key &);

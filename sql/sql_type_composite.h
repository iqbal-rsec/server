...
public:
  ...
  */
  ...
  virtual Field *get_field(THD *thd, Item_field *item, const LEX_CSTRING& name) const = 0;
  virtual Field *get_field(THD *thd, const Item_field *item, const LEX_CSTRING& name) const = 0;
};
